    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nearby-card { position: relative; overflow: hidden; height: 450px; flex: 1; }
        ...
        <div className="containerl" style={{ padding:'0 4rem' }}>
          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'1.5rem 0' }}>
            ...
            <nav style={{ display:'flex', alignItems:'center', gap:'2rem', fontSize:'0.95rem' }}>
              ...
              <a href="https://lromanarealestate.com/agentes" style={{ color:'#fff', textDecoration:'none' }}>Agentes</a>
      ...
      {/* INTRO */}
      <section style={{ background:'#121212', paddingTop:'5rem', paddingBottom:0 }}>
        <div className="containerl" style={{ paddingLeft:'4rem', paddingRight:'4rem', textAlign:'center', paddingBottom:'3rem' }}>
          <p style={{ color:'#fff', fontSize:'clamp(1.1rem,2.5vw,2rem)', lineHeight:1.7, fontWeight:500, marginBottom:0 }}>
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/atardecer.jpg" alt="Frailejón Village villas con jardín tropical" onClick={() => open('/atardecer.jpg', 'Frailejón Village')} style={{ width:'100%', height:'auto', display:'block', cursor:'zoom-in' }} />
      </section>
      ...
      {/* ESTILO DE VIDA */}
      <section style={{ background:'#121212', marginBottom:'2.5rem', paddingTop:'4rem', paddingBottom:0 }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/4.jpg" alt="Terraza con comedor y vista al jardín y piscina" onClick={() => open('/4.jpg', 'Terraza con comedor y vista al jardín y piscina')} style={{ width:'100%', height:'auto', display:'block', cursor:'zoom-in' }} />
        <div className="containerl" style={{ paddingLeft:'4rem', paddingRight:'4rem', paddingTop:'3rem', paddingBottom:'4rem' }}>
      ...
      <section style={{ background:'#121212' }}>
        <div style={{ display:'flex', flexWrap:'wrap', alignItems:'stretch' }}>
          <div style={{ flex:'2 1 60%', minWidth:300 }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/VILLAS.jpg" alt="Villas Frailejón Village vista nocturna" onClick={() => open('/VILLAS.jpg', 'Villas Frailejón Village')} style={{ width:'100%', height:'100%', objectFit:'cover', display:'block', cursor:'zoom-in', minHeight:500 }} />
          </div>
          <div style={{ flex:'1 1 35%', minWidth:280, color:'#fff', background:'#121212', padding:'4rem 3rem', display:'flex', flexDirection:'column', justifyContent:'center' }}>
            <h2 style={{ fontSize:'clamp(1.8rem,3vw,3rem)', fontWeight:300, marginBottom:'2rem', lineHeight:1.2 }}>
        ...
        <div style={{ padding:'0 4rem' }}>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'4rem', alignItems:'start' }}>
            <div>
              ...
              <p style={{ color:'#9ca3af', fontSize:'1.1rem', lineHeight:1.8, marginTop:'1rem' }}>
                Frailejón Village está ubicado dentro de La Estancia Golf &amp; Country Club, una zona exclusiva de La Romana con gran potencial de crecimiento y plusvalía. Su ubicación estratégica, entorno natural, seguridad y cercanía a playas, golf, aeropuerto y principales atractivos turísticos lo convierten en una excelente oportunidad tanto para vivir como para invertir y generar ingresos por renta vacacional.
              </p>
            </div>
      ...
      {/* AMENIDADES */}
      <section style={{ background:'#121212', padding:'5rem 0', marginBottom:'2.5rem' }}>
        <div style={{ paddingLeft:'4rem', paddingRight:'0' }}>
            ...
            <div style={{ position:'relative', minHeight:220, overflow:'hidden' }}>
              <div style={{ display:'flex', transform:`translateX(-${amenSlide * 100}%)`, transition:'transform 0.5s ease-in-out', height:'100%' }}>
                {amenSliderImages.map((img, i) => (
                  <div key={i} style={{ width:'100%', height:'100%', flexShrink:0, minHeight:220 }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      <section id="modelos" style={{ background:'#121212', padding:'5rem 1rem', marginBottom:'3rem' }}>
        <div className="containerl" style={{ paddingLeft:'4rem', paddingRight:'4rem' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))', gap:'10rem' }}>
            {[
      ...
      {/* ATRACTIVOS */}
      <section style={{ background:'#121212', padding:'5rem 0' }}>
        <div style={{ paddingLeft:'0', paddingRight:'0' }}>
          <h2 style={{ color:'#fff', fontSize:'clamp(2rem,4vw,3rem)', fontWeight:700, textAlign:'center', marginBottom:'3rem', paddingLeft:'4rem' }}>
      ...
      {/* CONTACTO */}
      <section id="contact" style={{ background:'#121212', padding:'5rem 0 5rem 0' }}>
